...
const testRoute = createRoute({
  ...
  request: { params: mcpIdParamSchema },
  responses: { 200: { description: 'Connection test result', ...jsonRes } },
});
