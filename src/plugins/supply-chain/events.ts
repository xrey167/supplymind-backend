/**
 * Supply chain domain event payload schemas.
 *
 * Zod schemas for all supply chain event payloads. These are the canonical
 * definitions — contracts/events/index.ts re-exports from here.
 */
